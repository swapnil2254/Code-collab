        ...
        >
            {openFiles.map((file) => (
                <span
                    key={file.id}
                    className={cn(
                        "flex w-fit cursor-pointer items-center rounded-t-md px-2 py-1 text-dark",
                        { "bg-slate-300 ": file.id === activeFile?.id },
                    )}
                ...
                >
                    ...
                    <IoClose
                        className="ml-3 inline rounded-md hover:bg-slate-200"
                        size={20}
