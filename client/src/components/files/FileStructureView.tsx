...
function Directory({
    ...
    return (
        <div className="overflow-x-auto">
            <div
                className="flex w-full items-center rounded-md px-2 py-1 hover:bg-slate-200"
    ...
    return (
        ...
        >
            <button
                ...
                className="flex w-full items-center gap-2 rounded-md px-2 py-1 hover:bg-slate-200"
            >
            ...
            <button
                ...
                className="flex w-full items-center gap-2 rounded-md px-2 py-1 text-danger hover:bg-slate-200"
            >
                <MdDelete size={20} />
                Delete
            </button>
