        ...
        >
            ...
            <div className="flex h-[90%] w-full flex-col items-end gap-2 md:h-[92%]">
                <div className="relative w-full">
                    <select
                        className="w-full rounded-md border-none  bg-slate-100 px-4 py-2 text-dark outline-none"
                    ...
                    <PiCaretDownBold
                        size={16}
                        className="absolute bottom-3 right-4 z-10 text-dark"
                    />
                </div>
                <textarea
                    className="min-h-[120px] w-full resize-none rounded-md border-none  bg-slate-100 p-2 text-dark outline-none"
                ...
                <div className="w-full flex-grow resize-none overflow-y-auto rounded-md border-none  bg-slate-100 p-2 text-dark outline-none">
                    <code>
