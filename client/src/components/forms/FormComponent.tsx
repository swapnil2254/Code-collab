...
const FormComponent = () => {
    ...
    return (
        <div className="flex w-full max-w-[400px] flex-col items-center justify-center gap-4 p-4 sm:w-[500px] sm:p-8">
            ...
            <form onSubmit={joinRoom} className="flex w-full flex-col gap-4">
                <input
                    ...
                    name="roomId"
                    placeholder="Room Id"
                    className="w-full rounded-md border border-gray-500  px-3 py-3 focus:outline-none"
